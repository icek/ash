...
export class Entity {
     ...
     */
    public componentAdded:Signal2<Entity, { new( ..._:any[] ):any; }>;
    /**
     * This signal is dispatched when a component is removed from the entity.
     */
    public componentRemoved:Signal2<Entity, { new( ..._:any[] ):any; }>;
    /**
    ...
    public next:Entity;
    public components:ClassMap<{ new( ..._:any[] ):any }, any>;
    ...
    constructor( name:string = '' ) {
        ...
        this.components = new ClassMap<{ new( ..._:any[] ):any }, any>();
        if( name ) {
            this._name = name;
        }
        else {
    ...
    public add<T>( component:T, componentClass:{ new( ..._:any[] ):T; } = null ):this {
        if( !componentClass ) {
     ...
     */
    public remove<T>( componentClass:{ new( ..._:any[] ):T; } ):T {
     ...
     */
    public get<T>( componentClass:{ new( ..._:any[] ):T; } ):T {
     ...
     */
    public has<T>( componentClass:{ new( ..._:any[] ):T; } ):boolean {
