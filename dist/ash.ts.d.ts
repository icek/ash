...
declare module 'ash.ts' {
  export { ClassType } from 'ash.ts/types';
...
declare module 'ash.ts/core/Engine' {
  ...
  export class Engine {
    ...
    getNodeList<TNode extends Node<any>>(nodeClass: { new (): TNode }): NodeList<TNode>;
    releaseNodeList<TNode extends Node<any>>(nodeClass: { new (): TNode }): void;
...
declare module 'ash.ts/tools/ComponentPool' {
  export class ComponentPool {
    static get<T>(componentClass: { new (): T }): T;
